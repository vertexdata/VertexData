...
const data = {
  ...
  rows: [
    ...
    { feature: 'Monthly Starting Price', jevus: 'Custom', competitor: '$292.50/mo + per call' },
  ...
  faqs: [
    ...
    { question: 'How do the costs compare?', answer: "Smith.ai starts at $292.50/month for their base plan but charges per call on top. A busy contractor receiving 100+ calls/month can easily spend $500-800+/month. Jevus is a simple flat monthly plan with unlimited calls — no per-minute or per-call charges. Book a call for a custom quote." },
